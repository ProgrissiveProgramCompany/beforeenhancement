		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="#" method="post">
					...
					<div class="clearfix"> </div>
					<input type="text" placeholder="Country phone" required=" " >
					<div class="clearfix"> </div>
					<input type="email" placeholder="E_mail address" required=" " >
				...
				<h6>Payment</h6>
					...
					<input type="submit" onclick="done()" value="Submit order">
				</form>
			</div>
...
<script type="text/javascript">
	function done(){
       alert("your requirst is done succssfully");
